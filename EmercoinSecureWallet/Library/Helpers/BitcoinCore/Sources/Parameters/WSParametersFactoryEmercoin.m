...
@interface WSParametersFactoryEmercoin ()

@property (nonatomic, strong) WSParameters *parameters;

@end

@implementation WSParametersFactoryEmercoin

- (instancetype)init
{
    if ((self = [super init])) {
        WSParametersBuilder *builder = [[WSParametersBuilder alloc] initWithNetworkType:WSNetworkTypeEmercoin];
        
        builder.magicNumber                 = 0xe6e8e9e5;
        builder.publicKeyAddressVersion     = 0x21;
        builder.scriptAddressVersion        = 0x5c;
